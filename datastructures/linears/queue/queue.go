...
func New[T any]() *Queue[T] { return NewWithCapacity[T](0) }
...
func (queue *Queue[T]) array() *array.Array[T] { return (*array.Array[T])(queue) }

func (queue *Queue[T]) Empty() bool  { return queue.array().Size() == 0 }
func (queue *Queue[T]) Push(value T) { queue.array().Append(value) }
func (queue *Queue[T]) Peek() T      { return queue.array().Get(0) }
