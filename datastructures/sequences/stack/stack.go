...
func NewFrom[T any](sequence collections.Collection[T]) Stack[T] {
	return Stack[T]{sequence}
}

func New[T any]() Stack[T] {
	return Stack[T]{array.New[T]()}
}

func (stack Stack[T]) Empty() bool {
	return stack.sequence.Size() == 0
}

func (stack Stack[T]) Push(value T) {
	stack.sequence.Append(value)
}

func (stack Stack[T]) Peek() T {
	return stack.sequence.Get(-1)
}
